...
export const Card = observer(() => {
  ...
  async function processExport() {
    try {
      await ipcRenderer.invoke('generate-pdf')
  ...
  return (
    <div className="card-generator" >
      ...
      <div onClick={() => { cardGeneratorStore.markAsDone() }} className={`text ${cardGeneratorStore.currentRow.data.image.shape === 'portrait' ? 'left' : ''}`} style={{ fontSize: fontSize, lineHeight: (fontSize + 5) + 'px' }}>
